        ...
        <div className="max-w-4xl mx-auto space-y-24">
          ...
          <div className="mt-16 pb-20 max-w-4xl mx-auto px-4">
             ...
             <div className="text-gray-600 leading-relaxed text-sm sm:text-base mb-8 space-y-4 text-center sm:text-left">
                ...
                <p>
                  Want to deposit money into your account or buy something online? You can rest assured that your payment data will be processed with accuracy. We ensure that we make the payment methods as versatile as possible to enable any user to start using SMM services from any part of the world.
                </p>
             </div>
