...
const rawTranslations: Record<Language, any> = {
  ...
  hi: {
    landingBadge: '🚀 सर्वश्रेष्ठ ऑटो-डिलीवरी मार्केटप्लेस', landingHeadline: 'ताज़ा उच्च गुणवत्ता वाले टेलीग्राम खाते। तुरंत।', landingSub: 'प्रीमियम टेलीग्राम खातों के लिए सबसे उन्नत बाजार।', landingCreateBtn: 'खाता बनाएं', landingFeatures: ['सत्यापित गुणवत्ता', 'पूरी तरह से स्वचालित'], landingCountryStock: 'स्टॉक:', landingBuyAcc: 'खाता खरीदें', landingFeat1Title: 'त्वरित स्वचालित डिलीवरी', landingFeat1Desc: 'हमारा प्लेटफॉर्म सीधे विक्रेता बॉट से जुड़ा है।', landingFeat2Title: 'पूरी तरह से स्वचालित टॉप-अप', landingFeat2Desc: 'अपने बैलेंस को 24/7 ऑटोमैटिकली टॉप-अप करें।', landingFeat3Title: 'एफिलिएट प्रोग्राम', landingFeat3Desc: 'दोस्तों को आमंत्रित करें और लाइफटाइम कमीशन कमाएं।', landingFooter: '© 2024 TeleBot Shop। सर्वाधिकार सुरक्षित।',
  ...
  es: {
    landingBadge: '🚀 El Marketplace Definitivo', landingHeadline: 'Cuentas Premium de Telegram. Al instante.', landingSub: 'El marketplace más avanzado y automatizado de la web.', landingCreateBtn: 'Crear cuenta', landingFeatures: ['Calidad Verificada', '100% Automático'], landingCountryStock: 'Stock:', landingBuyAcc: 'Comprar Cuenta', landingFeat1Title: 'Entrega Inmediata', landingFeat1Desc: 'Conectado directo a los bots vendedores para entrega rápida.', landingFeat2Title: 'Top-ups Automáticos', landingFeat2Desc: 'Recarga tu saldo 24/7 automáticamente.', landingFeat3Title: 'Programa de Afiliados', landingFeat3Desc: 'Invita amigos y gana 1% de comisión.', landingFooter: '© 2024 TeleBot Shop. Todos los derechos reservados.',
  ...
  ar: {
    landingBadge: '🚀 أفضل منصة تداول آلية', landingHeadline: 'حسابات تيليجرام طازجة وعالية الجودة. فوراً.', landingSub: 'الأكثر تقدماً وأتمتة.', landingCreateBtn: 'إنشاء حساب', landingFeatures: ['جودة مضمونة', 'آلي بالكامل'], landingCountryStock: 'المخزون:', landingBuyAcc: 'شراء حساب', landingFeat1Title: 'تسليم فوري', landingFeat1Desc: 'منصتنا مرتبطة مباشرة بالبائعين.', landingFeat2Title: 'شحن آلي', landingFeat2Desc: 'اشحن رصيدك تلقائيا 24/7.', landingFeat3Title: 'برنامج الإحالة', landingFeat3Desc: 'قم بدعوة اصدقائك واربح 1%.', landingFooter: '© 2024 متجر TeleBot. جميع الحقوق محفوظة.',
  ...
  ru: {
    landingBadge: '🚀 Лучший автомаркетплейс', landingHeadline: 'Свежие Telegram Аккаунты. Мгновенно.', landingSub: 'Самый продвинутый магазин телеграм аккаунтов.', landingCreateBtn: 'Создать Аккаунт', landingFeatures: ['Качество', 'Автоматизация'], landingCountryStock: 'Наличие:', landingBuyAcc: 'Купить аккаунт', landingFeat1Title: 'Моментальная доставка', landingFeat1Desc: 'Подключено к ботам-', landingFeat2Title: 'Автоматическое пополнение', landingFeat2Desc: 'Пополняйте баланс 24/7.', landingFeat3Title: 'Партнерская программа', landingFeat3Desc: 'Приглашайте друзей и получайте 1%.', landingFooter: '© 2024 TeleBot Shop.', 
  ...
  zh: {
    landingBadge: '🚀 顶级全自动发卡平台', landingHeadline: '高质量Telegram账号。秒发货。', landingSub: '最先进的全自动平台。', landingCreateBtn: '创建账户', landingFeatures: ['已验证质量', '全自动'], landingCountryStock: '库存:', landingBuyAcc: '购买账户', landingFeat1Title: '实时发货', landingFeat1Desc: '我们的平台直连卖家。', landingFeat2Title: '全自动充值', landingFeat2Desc: '7x24小时全自动充值。', landingFeat3Title: '推广计划', landingFeat3Desc: '邀请好友赚取1%佣金。', landingFooter: '© 2024 TeleBot Shop. 保留所有权利。',
...
export const t: Record<Language, any> = new Proxy(rawTranslations, {
  get(target, langProp) {
    if (typeof langProp !== "string") return (target as any)[langProp];
    const langRaw = target[langProp as Language];
    if (!langRaw) return target.en;
    return new Proxy(langRaw, {
      get(langTarget, key) {
        if (langTarget[key] !== undefined) {
          return langTarget[key];
        }
